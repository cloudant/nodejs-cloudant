...
class IAMTokenManager extends TokenManager {
  constructor(client, jar, sessionUrl, iamTokenUrl, iamApiKey, iamClientId, iamClientSecret) {
    ...
    this._reqToken = undefined;
    this._reqSession = undefined;
  }
  ...
  _closeRequest() {
    this._reqToken.abort();
    if (this._reqSession !== undefined) {
      this._reqSession.abort();
    }
  }
}
